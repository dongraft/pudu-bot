#
# Description:
#   Feeds mauricio when it deserves it or when he's starving.
#
# Dependencies:
#   None
#
...
#
# Commands:
#   mauricio <toma|come|alimentate|traga|engulle> <food|emoji>
#
# Author:
...
blacklist = ['mauricio','carne','pollo','caca',':meat_on_bone:',':pultry_leg:',':egg:',':hamburger:']
