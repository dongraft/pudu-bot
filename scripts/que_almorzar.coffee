...
#
# Commands:
#   @mauricio qu[ée] desayunar|almorzar|cenar
#
# Author:
#   jorgeepunan
...
module.exports = (robot) ->
  robot.respond /qu[ée] desayunar/gi, (msg) ->
    msg.send ":mauricio: Te sugiero: " + msg.random desayuno

  robot.respond /qu[ée] almorzar/gi, (msg) ->
    msg.send ":mauricio: Te sugiero: " + msg.random almuerzo

  robot.respond /qu[ée] cenar/gi, (msg) ->
    msg.send ":mauricio: Para el *anvre*: " + msg.random cena

  robot.respond /qu[ée] tomar/gi, (msg) ->
    msg.send ":mauricio: Si tienes sed: " + msg.random bebidas

  robot.respond /qu[ée] cerveza tomar/gi, (msg) ->
    msg.send ":mauricio: Si tienes sed: " + msg.random cervezas

  robot.respond /qu[ée] comer/gi, (msg) ->
    msg.send ":mauricio: Depende de la comida para: *desayunar*, *almorzar* ó *cenar*. Pregúntame de nuevo."