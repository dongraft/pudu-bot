...
//
// Commands:
//   @mauricio beerjs info|todo
//   @mauricio beerjs fecha|cuando
//   @mauricio beerjs donde|lugar
//   @mauricio beerjs tema
//
// Author:
		  	...
		  	var obj = JSON.parse(response.body);
	  	 	...
	  	 	if ( suffix === "fecha" || suffix === "cuando") {
			  	res.send(">*" + obj.evento + ":* " + obj.fecha);
					...
					res.send("¿Ayuda? Comandos: @mauricio beerjs [fecha|cuando, donde|lugar, tema]");
				}
